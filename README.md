...
- The general process for training our clustering generated pseudo-label-based self-supervised speaker embedding networks: ![](/process_PL_based_speaker_embedding_training.png)
