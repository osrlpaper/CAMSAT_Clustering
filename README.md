...
- Heatmap plot of the Pearson product-moment correlation coefficients between the clustering metrics and the speaker verification EER validation performance for classical (non-deep) models verus deep-learning-based clustering models: ![](/eer_heatmap_classical_vs_deep.png)
